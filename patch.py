...
js_path = r'e:\SEO agency\js\pageTemplateEngine.js'
with open(js_path, 'r', encoding='utf-8') as f:
    lines = f.readlines()

new_html = r'''      html: `<div class="public-layout" style="background-color:#FFFFFF;color:#0F172A;font-family:var(--font-main);margin:0;padding:0;width:100%;">
...
with open(js_path, 'w', encoding='utf-8') as f:
    ...
    f.write(new_html)
    f.writelines(lines[302:])

css_path = r'e:\SEO agency\css\styles.css'
css_append = r'''
